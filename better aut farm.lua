...
for i,v in pairs(game.workspace.Living:GetChildren()) do 
    if v.Name == 'Boa H' or v.Name == 'Hold up, aint you Dio?' or v.Name == 'Professor Diavolo' or v.Name == 'Minos Prime' or v.Name == 'Puddest' or v.Name == 'Bur, The Fifth Disciple of Bon Shaker' then
...
local table = {
    ...
    ['Domain'] = CFrame.new(17239, 912, -77)
}

LeftGroupBox:AddDropdown('TPs', {
    Values = { ' ','Spawn', 'Diavolo Spawn', 'Boss Altar', 'Dio Spawn','Soccer Field','Sakuya Room','Domain'},
